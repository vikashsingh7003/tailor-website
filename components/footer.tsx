      ...
      <div className="relative z-10 border-t border-[#494949]">
            ...
            >
              <Link href="/" className="inline-block">
                <span className="flex items-center justify-start">
                  <img src="/images/logo-wiwi.png" alt="WIWI Logo" className='h-40 w-40 object-contain -ml-4' />
                </span>
              </Link>
        ...
        <div className="border-t border-[#494949] bg-[#000000]">
          <div className="container mx-auto px-6 lg:px-12 py-6">
            <p className="text-center text-[#7d7d7d] text-[12px] uppercase font-lambotype tracking-[0.023em]">
              {t.footer.copyright}
            </p>
          </div>
        </div>
